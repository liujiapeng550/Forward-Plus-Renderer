...
int main(int argc, char **argv) {
	...
	Shader depthShader("G:\\demo\\Forward-Plus-Renderer\\Forward-Plus\\Forward-Plus\\source\\shaders\\depth.vert.glsl",
		"G:\\demo\\Forward-Plus-Renderer\\Forward-Plus\\Forward-Plus\\source\\shaders\\depth.frag.glsl", NULL);
	Shader lightCullingShader("G:\\demo\\Forward-Plus-Renderer\\Forward-Plus\\Forward-Plus\\source\\shaders\\light_culling.comp.glsl");

#if defined(DEPTH_DEBUG)
	Shader depthDebugShader("G:\\demo\\Forward-Plus-Renderer\\Forward-Plus\\Forward-Plus\\source\\shaders\\depth_debug.vert.glsl",
		"G:\\demo\\Forward-Plus-Renderer\\Forward-Plus\\Forward-Plus\\source\\shaders\\depth_debug.frag.glsl", NULL);
#elif defined(LIGHT_DEBUG)
	Shader lightDebugShader("G:\\demo\\Forward-Plus-Renderer\\Forward-Plus\\Forward-Plus\\source\\shaders\\light_debug.vert.glsl",
		"G:\\demo\\Forward-Plus-Renderer\\Forward-Plus\\Forward-Plus\\source\\shaders\\light_debug.frag.glsl", NULL);
#else
	Shader lightAccumulationShader("G:\\demo\\Forward-Plus-Renderer\\Forward-Plus\\Forward-Plus\\source\\shaders\\light_accumulation.vert.glsl",
		"G:\\demo\\Forward-Plus-Renderer\\Forward-Plus\\Forward-Plus\\source\\shaders\\light_accumulation.frag.glsl", NULL);
	Shader hdrShader("G:\\demo\\Forward-Plus-Renderer\\Forward-Plus\\Forward-Plus\\source\\shaders\\hdr.vert.glsl",
		"G:\\demo\\Forward-Plus-Renderer\\Forward-Plus\\Forward-Plus\\source\\shaders\\hdr.frag.glsl", NULL);
#endif
	...
	Model sponzaModel("G:\\demo\\Forward-Plus-Renderer\\Forward-Plus\\Forward-Plus\\crytek-sponza\\sponza.obj");
